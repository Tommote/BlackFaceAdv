...
class IBasicBlock(nn.Cell):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
        ...
        self.bn1 = nn.BatchNorm2d(num_features=inplanes, eps=1e-05, momentum=momentum)
        self.conv1 = conv3x3(inplanes, planes)
        self.bn2 = nn.BatchNorm2d(num_features=planes, eps=1e-05, momentum=momentum)
        self.prelu = nn.PReLU(channel=planes)
        self.conv2 = conv3x3(planes, planes, stride)
        self.bn3 = nn.BatchNorm2d(num_features=planes, eps=1e-05, momentum=momentum)
...
class IResNet(nn.Cell):
    ...
    def __init__(self,
        ...
        self.bn1 = nn.BatchNorm2d(num_features=self.inplanes, eps=1e-05, momentum=momentum)
        ...
        self.bn2 = nn.BatchNorm2d(num_features=512 * block.expansion, eps=1e-05, momentum=momentum)
        ...
        self.features = nn.BatchNorm1d(num_features=num_features, eps=1e-05, momentum=momentum)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.SequentialCell([
                ...
                nn.BatchNorm2d(num_features=planes * block.expansion, eps=1e-05, momentum=momentum),
            ])
        layers = []
        layers.append(
